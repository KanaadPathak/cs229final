...
\headerbox{Experimental Results}{name=results,column=1,span=2,row=0}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %\begin{tabular}{c@{}c@{}}
  $\vcenter{\hbox{\includegraphics[width=0.40\linewidth]{test_accuracy}}}$
  $\vcenter{\hbox{\includegraphics[width=0.55\linewidth]{best_cm_uniform}}}$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  ResNet50 for transfer learning, since ResNet uses Average Pooling before connect to the Fully connected layers, this
  ...
  like edge and shape through the generated filters. (See the two filters extracted by the first Conv Layer, they
  looks like representing the leaf itself and the background respectively.)
  %\vspace{0.3em}
  ...
  on top. Except for the first Conv Layer, the rest 48 composes 16
  ``residual'' blocks in total with in 4 stages. The block within each stage has similar architecture of same
  input shape and output shape. \par
