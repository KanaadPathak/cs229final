...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  In another word, it outputs a much lower dimension features which helps the prediction accuracy.
  %\vspace{0.3em}
  ...
  The output of the stage 5 give 2048 features. Every cell in the grid shown above is a 8x8 filter visualized with
