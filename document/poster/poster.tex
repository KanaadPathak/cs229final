...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  After comparing, we choose ResNet50. Since ResNet50 uses a more aggressive Average Pooling
  with a pool size of 7x7, which makes the output dimension of the bottleneck layer much smaller than VGG architectures',
  it outputs a much smaller feature set which helps the prediction accuracy.
  %\vspace{0.3em}
  ...
  The output of the stage 5 give 2048 features. Every cell in the grid shown above is a 8x8 filter, which will be a
